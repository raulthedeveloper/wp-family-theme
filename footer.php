...
<?php  while ( $the_query->have_posts() ): 
    ...
    ?>
            <div >
                ...
                <ul >
                    <li style="color: #a3a3a3" class="footer-text"><span><svg  xmlns="http://www.w3.org/2000/svg" width="<?php echo $iconsize ?>"
                    ...
                    <li style="color: #a3a3a3" class="footer-text"><svg  xmlns="http://www.w3.org/2000/svg" width="16" height="16"
  ...
  <?php  while ( $the_query->have_posts() ): 
    ...
    ?>
                    <a target="_blank" href="<?php echo get_field('business_facebook') ?>">
                        <svg class="social-media-icons svg-footer" xmlns="http://www.w3.org/2000/svg" width="<?php echo $iconsize?>"
